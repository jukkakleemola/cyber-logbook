...
export async function getResources(req) {
    const query = `SELECT resource_id, resource_name, resource_description FROM xyz123_resources`;
    try {
...
export async function registerResource(req) {
    ...
    try {
        const query = `INSERT INTO xyz123_resources (resource_name, resource_description) VALUES ($1, $2)`;
