...
async function getUserUUID(username) {
    const result = await client.queryArray(`SELECT user_token FROM xyz123_users WHERE username = $1`, [username]);
...
export async function registerReservation(req) {
    ...
    try {
        ...
        const query = `INSERT INTO xyz123_reservations (reserver_token, resource_id, reservation_start, reservation_end) VALUES ($1, $2, $3, $4)`;
